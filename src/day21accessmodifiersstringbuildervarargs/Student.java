...
public class Student {
	...
	// the entire package
	int age = 13; // default, but we never write it, it is default
	...
	protected int grade = 11;  // see example how it works in day20, class Grade01, we are able to use grade from that package.
	
	// If you use "public" access modifier, the class member will be
	// visible from entire project
