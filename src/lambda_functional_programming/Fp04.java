...
public class Fp04 {
	...
	public static void main(String[] args) {
		...
		System.out.println(calculateFactorial01(6)); // 720
		System.out.println(calculateFactorial02(5)); // 120
		System.out.println(sumOfIntegersInGivenRange(11, 100)); // 2520
	...
	public static int sumOfIntegersInGivenRange(int s, int e) { // we add some conditions to enable method to calculate negative numbers
		int x =0;
		if (s>e) {
			x=s;
			s=e;
