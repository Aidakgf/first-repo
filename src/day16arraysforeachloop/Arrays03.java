...
public class Arrays03 {
	...
	public static void main(String[] args) {
		...
		if(counter ==1) {
			...
			System.out.println(expectedElement + " does not exist in array");
		}
		...
		// c) 	before using binarySearch() method you have to use sort() method, otherwise the output you got does not
		// 		have any meaning
		// d)	binarySearch() method does not give stable outputs for repeated values
