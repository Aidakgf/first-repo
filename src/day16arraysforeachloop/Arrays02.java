...
public class Arrays02 {
	...
	// Check if array elements are sorted or not (ascending order)
	...
	public static void main(String[] args) {
		...
		// If you use "String s2[] = s1;" instead of "copyOf()" method
		// everytime you will get "Array elements are sorted" message. Because when you sort s1, s2 will be sorted as well.
