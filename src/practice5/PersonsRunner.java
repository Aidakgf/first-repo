...
public class PersonsRunner {
	...
	public static void main(String[] args) {
        ...
        System.out.println(persons.get(1).getAge()); // 4 age of person2 under index 1
        ...
        Map<String, Integer>namesWithFrequencies = new HashMap<>(); // empty at the beginning
        ...
        System.out.println(namesWithFrequencies); // {Ahmet=1, Nihal=1, Osman=2, Selcuk=1, Nedime=1}
         	
         	
         	
		//	2)Type all the names on the console without repetition
        System.out.println("================ Task 2 ================");
        System.out.println(namesWithFrequencies.keySet()); // [Ahmet, Nihal, Osman, Selcuk, Nedime]
			
			
			
		//	3) Create a method to return the oldest person
        System.out.println("================ Task 3 ================");
        System.out.println(oldestPerson(persons)); // Person [name=Selcuk, lastname=Kar, age=65, email=null]
        ...
        System.out.println(agesSorted); // we got ages butnot sorted [55, 4, 23, 15, 65, 24]
        Collections.sort(agesSorted); // to sort ages
        System.out.println(agesSorted); // [4, 15, 23, 24, 55, 65]
        ...
        System.out.println(Arrays.toString(agesSorted2)); // [4, 15, 23, 24, 55, 65]
        
        // Way 3 TreeSet (but it's not dynamic), if ages are unique we can use TreeSet
        ...
        for(Person p : persons) {
            if(p.getAge()==24) {
                System.out.println(p.getName()); // Nedime
            }
        }
        
        
        // 7) What are the names-lastnames who are older than 20?
        ...
        // 8) What is the age of the first person in the alphabetical order of lastname?
        
        
        // 9) Type the lastname with their length
